...
for subset in subsets:
    # Paths
    masks_dir = os.path.join(output_base_dir, subset, 'masks')  # Directory with RV masks
    annotations_dir = os.path.join(output_base_dir, subset, 'annotations')  # Directory to save annotations
    ...
    for mask_file in tqdm(mask_files, desc=f'Processing masks in {subset}'):
    ...
    yolo_labels_dir = os.path.join(output_base_dir, subset, 'yolo_labels')
